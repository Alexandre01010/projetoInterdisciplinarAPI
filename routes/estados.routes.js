...
const estadoController = require("../controllers/estados.controllers.js");
...
router.route('/')
    .get(estadoController.findAll) // this route will capture requests with query strings
    

router.route('/:estadoID')
    .get(estadoController.findOneEstado); // get the estado 
